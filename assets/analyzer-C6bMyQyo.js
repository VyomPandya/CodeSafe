const h=()=>{let e="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";return console.log(`Using OpenRouter API key (starts with: ${e.substring(0,5)}...)`),e},p=()=>h();p()||console.warn("OpenRouter API key not found, local analysis will be used as fallback");async function y(e,a="mistralai/mistral-7b-instruct-v0.2:free"){var l,s;const u=await e.text(),n=(l=e.name.split(".").pop())==null?void 0:l.toLowerCase();if(!p())return console.warn("OpenRouter API key not found, using local analysis"),d(u,n||"",e.name);console.log(`Analyzing code using model: ${a}`);try{const i=`
