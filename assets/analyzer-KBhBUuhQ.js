const m=()=>"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",h=()=>m();async function y(e,a="nvidia/llama-3.1-nemotron-nano-8b-v1:free"){var l,s;const u=await e.text(),n=(l=e.name.split(".").pop())==null?void 0:l.toLowerCase();console.log(`Analyzing code using model: ${a}`);try{const i=`
